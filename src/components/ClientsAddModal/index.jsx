...
function ClientsAddModal({ onClose }) {
  ...
  const checkZipCode = async (code) => {
    try {
      ...
      // chama corretamente na api mas so preenche os dados se apagar um digito no cep
      ...
      <form className='add-modal-form' onSubmit={handleSubmit}>
        ...
        <div className="add-modal-row">
          <div className='add-modal-row-col'>
            ...
            <input type="text" className={`add-modal-form-input ${errorCpf ? 'add-modal-error-border-input' : ''}`} placeholder='Digite o cpf' id='input-cpf' name='cpf' value={form.cpf} onChange={(e) => handleChangeForm(e)} />
            <span className='add-modal-error'>{errorCpf}</span>
          </div>
          <div className='add-modal-row-col'>
            <label htmlFor="input-phone">Telefone*</label>
            <input type="text" className={`add-modal-form-input ${errorPhone ? 'add-modal-error-border-input' : ''}`} placeholder='Digite o telefone' id='input-phone' name='phone' value={form.phone} onChange={(e) => handleChangeForm(e)} />
        ...
        <div className="add-modal-row">
          <div className='add-modal-row-col'>
            ...
            <input type="text" className='add-modal-form-input' maxLength={8} onBlur={() => checkZipCode(form.zipCode)} placeholder='Digite o CEP' id='input-zipCode' name='zipCode' value={form.zipCode} onChange={(e) => handleChangeForm(e)} />
          </div>
          <div className='add-modal-row-col'>
            <label htmlFor="input-district">Bairro</label>
            <input type="text" className='add-modal-form-input' placeholder='Digite o bairro' id='input-district' name='district' value={form.district} onChange={(e) => handleChangeForm(e)} />
          </div>
        </div>
        <div className="add-modal-row">
          <div className='add-modal-row-col'>
          ...
          <div className='add-modal-row-col'>
            ...
            <input type="text" className='add-modal-form-input' placeholder='Digite a UF' id='input-uf' name='uf' value={form.uf} onChange={(e) => handleChangeForm(e)} />
          </div>
        </div>
